...
class _RideHistoryScreenState extends State<RideHistoryScreen> {
  ...
  void initState() {
    ...
    if (uid != null) {
      context.read<RideProvider>().listenToRideHistory(uid);
    }
  }
...
class _StatusChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final (Color bg, Color fg) = switch (status) {
      RideStatus.requested => (Colors.orange.shade100, Colors.orange.shade800),
      RideStatus.accepted => (Colors.blue.shade100, Colors.blue.shade800),
      RideStatus.inProgress => (Colors.purple.shade100, Colors.purple.shade800),
